...
* Обновлена библиотека Quantumart.QP8.BLL до 3.6.6
* Снова стали показываться в интерфейсе серверные ошибки при публикации, архивировании
* Добавлена проверка на максимальный статус Workflow при редактировании, архивировании и восстановлении из архива


### 1.8.1.0

* Обновлена библиотека AutoMapper до 16.1.1
* Обновлена библиотека Quantumart.QP8.BLL до 3.6.3

### 1.8.0.0

* Переход на Node.js 24
* Исправлены уязвимости в зависимостях по npm audit
...
* Обновлена библиотека Quantumart.QP8.BLL до 3.5.1
